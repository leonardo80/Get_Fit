...
namespace GetFit.Shared.Pages
{
    ...
    public sealed partial class Register : Page
    {
        ...
        private void hyperTrainer_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(GetFit.Shared.Pages.RegisterTrainer));
        }
